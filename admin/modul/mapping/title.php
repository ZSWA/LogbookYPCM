...
<div class="row">
    <div class="table-responsive table--no-card m-b-30">
        <table class="table table-borderless table-striped table-earning">
            ...
            <tbody>
                <?php
                    include 'paging1.php'; // Load data dan logika paging untuk Tabel 1
                ?>
            </tbody>
        </table>
        <center>
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" <?php if($halaman1 > 1) { echo "href='?m=mapping&s=awal&halaman1=$previous1'"; } ?>>Previous</a>
                </li>
                <?php 
                for($x = 1; $x <= $total_halaman1; $x++) {
                    ?> 
                    <li class="page-item">
                        <a class="page-link" href="?m=mapping&s=awal&halaman1=<?php echo $x ?>"><?php echo $x; ?></a>
                    </li>
                    <?php
                }
                ?>              
                <li class="page-item">
                    <a class="page-link" <?php if($halaman1 < $total_halaman1) { echo "href='?m=mapping&s=awal&halaman1=$next1'"; } ?>>Next</a>
                </li>
            </ul>
        </center>
    </div>
...
<div class="row">
    <div class="table-responsive table--no-card m-b-30">
        <table class="table table-borderless table-striped table-earning">
            ...
            <tbody>
                <?php
                    include 'paging2.php'; // Load data dan logika paging untuk Tabel 2
                ?>
            </tbody>
        </table>
        <center>
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" <?php if($halaman2 > 1) { echo "href='?m=mapping&s=awal&halaman2=$previous2'"; } ?>>Previous</a>
                </li>
                <?php 
                for($x = 1; $x <= $total_halaman2; $x++) {
                    ?> 
                    <li class="page-item">
                        <a class="page-link" href="?m=mapping&s=awal&halaman2=<?php echo $x ?>"><?php echo $x; ?></a>
                    </li>
                    <?php
                }
                ?>              
                <li class="page-item">
                    <a class="page-link" <?php if($halaman2 < $total_halaman2) { echo "href='?m=mapping&s=awal&halaman2=$next2'"; } ?>>Next</a>
                </li>
            </ul>
        </center>
    </div>
