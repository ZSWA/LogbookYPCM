...
$data = mysqli_query($koneksi, "SELECT * FROM tb_riwintervensi");
$jumlah_data = mysqli_num_rows($data);
$total_halaman = ceil($jumlah_data / $batas);

$data_brg_in = mysqli_query($koneksi, "SELECT * FROM tb_riwintervensi LIMIT $halaman_awal, $batas");
...
while ($row=mysqli_fetch_array($data_brg_in)) {
 ...
 ?>
  ...
  <tr>
                                                ...
                                                <td><?php
                                                    include "../koneksi.php";
                                                    $id_fasilitator = $row['id_fasilitator'];
                                                    $query = "SELECT nama FROM tb_fasilitator WHERE NIK = '$id_fasilitator'";
                                                    $result = mysqli_query($koneksi, $query);
