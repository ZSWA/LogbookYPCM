  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Riwayat Intervensi</h1>
          </div>
        </div>
         ...
         <div class="row">
                ...
                <li class="page-item">
                    <a class="page-link" <?php if($halaman > 1){ echo "href='?m=riwayat&s=awal&halaman=$previous'"; } ?>>Previous</a>
                </li>
                <?php 
                for($x=1;$x<=$total_halaman;$x++){
                    ?> 
                    <li class="page-item"><a class="page-link" href="?m=riwayat&s=awal&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                    <?php
                }
                ?>              
                <li class="page-item">
                    <a  class="page-link" <?php if($halaman < $total_halaman) { echo "href='?m=riwayat&s=awal&halaman=$next'"; } ?>>Next</a>
                </li>
            </ul>
              </center>  
                                </div>
